...
public static class MoveDatabase
{
    ...
    static MoveDatabase()
    {
        ...
        All["wave-crash"] = new Move("웨이브태클", 120, PokemonType.Water, 10, 100, false, 0, false, false, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["axe-kick"] = new Move("발꿈치찍기", 120, PokemonType.Fighting, 10, 90, false, 0, false, false, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["raging-bull"] = new Move("레이징불", 90, PokemonType.Normal, 10, 100, false, 0, false, false, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["twin-beam"] = new Move("트윈빔", 40, PokemonType.Psychic, 10, 100, false, 0, false, true, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["hyper-drill"] = new Move("하이퍼드릴", 100, PokemonType.Normal, 5, 100, false, 0, false, false, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["comeuppance"] = new Move("앙갚음", 1, PokemonType.Dark, 10, 100, false, 0, false, false, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        All["psyshield-bash"] = new Move("배리어러시", 70, PokemonType.Psychic, 10, 90, false, 0, false, false, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["headlong-rush"] = new Move("들이받기", 120, PokemonType.Ground, 5, 100, false, 0, false, false, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["raging-fury"] = new Move("대격분", 120, PokemonType.Fire, 10, 100, false, 0, false, false, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["aqua-cutter"] = new Move("아쿠아커터", 70, PokemonType.Water, 20, 100, false, 0, false, false, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["mystical-power"] = new Move("신비의힘", 70, PokemonType.Psychic, 10, 90, false, 0, false, true, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["bleakwind-storm"] = new Move("찬바람폭풍", 100, PokemonType.Flying, 10, 80, false, 0, false, true, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        All["wildbolt-storm"] = new Move("번개폭풍", 100, PokemonType.Electric, 10, 80, false, 0, false, true, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
        ...
        All["sandsear-storm"] = new Move("열사의폭풍", 100, PokemonType.Ground, 10, 80, false, 0, false, true, "none", 0, 0, new List<StatChangeEntry>(), 0, "", 0, 0, 1, 1);
