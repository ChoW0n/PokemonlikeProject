...
public static partial class AbilityDatabase
{
    ...
    static AbilityDatabase()
    {
        ...
        All["애널라이즈"] = new AbilityInfo("애널라이즈", "제일 마지막에 기술을 쓰면 강해진다.");
        ...
        All["변덕쟁이"] = new AbilityInfo("변덕쟁이", "능력이 오르락내리락한다.");
        ...
        All["헤비메탈"] = new AbilityInfo("헤비메탈", "자신의 무게가 2배가 된다.");
        ...
        All["열폭주"] = new AbilityInfo("열폭주", "화상 상태일 때 특수공격의 위력이 올라간다.");
        ...
        All["미끈미끈"] = new AbilityInfo("미끈미끈", "접촉한 상대의 스피드를 떨어뜨린다.");
